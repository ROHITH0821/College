  ...
  return (
    <SearchProvider>
      <div className="relative min-h-screen">
        ...
        />
        <div className="min-h-screen min-w-0 max-w-full overflow-x-clip bg-white pl-[var(--sidebar-offset)] pt-[calc(env(safe-area-inset-top)+var(--utility-bar-inner)+3.5rem)] transition-[padding] duration-300 ease-out lg:pt-[var(--utility-bar-inner)]">
          {children}
        </div>
      </div>
    </SearchProvider>
